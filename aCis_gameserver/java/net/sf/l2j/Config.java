...
public final class Config
{
	...
	// L2jGO
	// --------------------------------------------------
	public static boolean CUSTOM_START_LEVEL_ALLOWED;
	public static int CUSTOM_START_LEVEL;
	...
	private static final void loadCustom(){
		final ExProperties custom = initProperties(CUSTOM);

		CUSTOM_START_LEVEL_ALLOWED = custom.getProperty("CustomStartLevelAllowed", false);
		CUSTOM_START_LEVEL = custom.getProperty("CustomStartLevel", 0);
